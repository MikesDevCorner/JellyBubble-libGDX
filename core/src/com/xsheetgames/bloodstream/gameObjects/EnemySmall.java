...
public class EnemySmall extends EnemyAbstract {

	public EnemySmall(World world, float x, float y) {
		super(world, x, y);
		this.ghostCounterStart = 0f;
		...
		super.init(bd, fd, GameAssets.objectLoader, "enemy", "enemy", Animation.PlayMode.NORMAL);
	}
